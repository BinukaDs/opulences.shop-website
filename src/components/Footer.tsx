...
const Footer = () => {
    return (
        <footer className='flex items-center justify-center md:p-20 bg-foreground w-full border-t border-border sticky bottom-0 z-10'>
                        ...
                        <div className="flex flex-col justify-center items-center md:items-start gap-3 ">
                            <a href="/">
                                <div className="flex gap-12 items-center justify-center">
                                    ...
                                    <h1 className="text-2xl text-white font-bold">Opulence</h1>
                                </div>
