...
const IntroSection = () => {
    return (
        <section className='py-24 bg-background flex flex-col items-center h-full w-full xl:px-24'>
            ...
            <div className="container">
                <div className="flex flex-col justify-between gap-6">
                    ...
                    <div className='py-12'>
                        ...
                        <div className='grid md:grid-cols-2 lg:grid-cols-2 lg:grid-rows-3 grid-rows-2 xl:grid-cols-3 py-10 gap-6'>
