        ...
        return (
            <div className="">
                <div className="flex justify-start items-center gap-6 ">
                    ...
                    <div>
                        <h1 className={` ${type === "regular" ? "text-textGray" : "text-textMuted"} text-lg`}>{text}</h1>
                    </div>
                ...
                <div className="flex flex-col gap-12 justify-between items-center">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-start w-full gap-24">
                        <div className="w-full h-full">
                            <Card className="bg-foreground flex flex-col items-center p-2 h-full">
                                ...
                                <CardContent className="items-center">
                                    ...
                                    <CardTitle><h1 className="text-5xl font-bold mt-1">70€</h1></CardTitle>
                                    <div>
                                        <h1 className="mt-5 font-bold text-white text-3xl">Regular Bundle</h1>
                        ...
                        <div className="w-full h-full">
                            <Card className="bg-linen flex flex-col items-center p-2">
                                <CardHeader className="flex justify-start">
                                ...
                                <CardContent className="items-center">
                                    ...
                                    <CardTitle><h1 className="text-5xl text-black font-bold mt-1">140€</h1></CardTitle>
                                    <div>
                                        <h1 className="mt-5 font-bold text-3xl text-black">Advanced Bundle</h1>
                                        <p className="text-textMuted mt-2">
                                            Perfect for growing businesses looking for comprehensive branding and design solutions.
                                        </p>
                                    </div>
                                    <div className="flex flex-col justify-start py-10 gap-6">
